...
<li class="active">Register Page Settings</li>
@stop
			...
			<div class="col-md-12">
				<div class="panel panel-flat">
					<div class="panel-heading">
						<h6 class="panel-title"><i class="icon-cogs"> </i>Register Page  Settings	</h6>
						<hr>
					</div>
					<div class="container-fluit">
					{!! Form::Open(['url' => '/admin/save-register-settings', 'method' => 'POST']) !!}
					<div class="row">
                        <div class="tabbable">
                            ...
                            <div class="tab-pane active" id="toolbar-justified-pill1">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12" style="margin-top:20px;">
                                        ...
                                        {!! Form::textarea($setting->name_setting, $setting->value, ['class' => 'form-control', 'placeholder' => '']) !!}
