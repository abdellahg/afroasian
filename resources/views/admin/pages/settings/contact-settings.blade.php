...
<li class="active">Contact us Settings</li>
@stop
			...
			<div class="col-md-12">
				<div class="panel panel-flat">
					<div class="panel-heading">
						<h6 class="panel-title"><i class="icon-cogs"> </i> Contact us Settings	</h6>
						<hr>
					</div>
					<div class="container-fluit">
					{!! Form::Open(['url' => '/admin/save-contact-settings', 'method' => 'POST']) !!}
					<div class="row">
                        <div class="tabbable">
